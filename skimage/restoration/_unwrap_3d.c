...
static const char __pyx_k_unwrap_3d_pyx[] = "_unwrap_3d.pyx";
...
static PyObject *__pyx_kp_s_unwrap_3d_pyx;
...
static PyObject *__pyx_pw_7skimage_11restoration_10_unwrap_3d_1unwrap_3d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("unwrap_3d (wrapper)", 0);
  {
    ...
    __pyx_v_image = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_image.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_mask = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_unsigned_char(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_mask.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_unwrapped_image = __Pyx_PyObject_to_MemoryviewSlice_d_d_dc_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_unwrapped_image.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_unwrap_3d_pyx, __pyx_k_unwrap_3d_pyx, sizeof(__pyx_k_unwrap_3d_pyx), 0, 0, 1, 0},
 ...
 *               double[:, :, ::1] unwrapped_image,
 */
  __pyx_tuple__19 = PyTuple_Pack(5, __pyx_n_s_image, __pyx_n_s_mask, __pyx_n_s_unwrapped_image, __pyx_n_s_wrap_around, __pyx_n_s_seed); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(5, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_unwrap_3d_pyx, __pyx_n_s_unwrap_3d, 9, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 9, __pyx_L1_error)
