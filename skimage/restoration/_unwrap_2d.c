...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "/root/scikit-image/skimage/restoration/_unwrap_2d.pyx"
        ]
    }, 
...
static PyObject *__pyx_pw_7skimage_11restoration_10_unwrap_2d_1unwrap_2d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("unwrap_2d (wrapper)", 0);
  {
    ...
    __pyx_v_mask = __Pyx_PyObject_to_MemoryviewSlice_d_dc_unsigned_char(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_mask.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_unwrapped_image = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_unwrapped_image.memview)) __PYX_ERR(0, 11, __pyx_L3_error)
